...
const CashoutRequestModal = ({ request }) => {
  const [centredModal, setCentredModal] = useState(false);
  const toggleShow = () => setCentredModal(!centredModal);

  const approveReject = useCashoutStore(state => state.approveRejectRequest);
  ...
  const handleApprove = () => {
    Swal.fire({
      title: "Are you sure you want to approve this commission request?",
      showDenyButton: true,
  ...
  const handleReject = () => {
    Swal.fire({
      title: "Are you sure you want to reject this commission request?",
      showDenyButton: true,
      confirmButtonText: "Yes",
      denyButtonText: `No`,
    }).then(result => {
