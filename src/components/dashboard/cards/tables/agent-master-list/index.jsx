...
const AgentMasterListTable = () => {
  const limit = 10;
  const [page, setPage] = useState(1);
  const [filter, setFilter] = useState("");

  const getAgents = useAgentStore(state => state.getMasters);
  const search = useAgentStore(state => state.searchMasters);
...
export default AgentMasterListTable;
