...
const AgentSubListTable = () => {
  const limit = 10;
  const [page, setPage] = useState(1);
  const [filter, setFilter] = useState("");

  const getAgents = useAgentStore(state => state.getSubs);
  const search = useAgentStore(state => state.searchSubs);
...
export default AgentSubListTable;
