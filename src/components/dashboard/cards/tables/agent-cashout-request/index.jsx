...
import AgentCashoutRequestTableRow from "./row";

const AgentCashoutRequestTable = () => {
  const limit = 10;
  const [page, setPage] = useState(1);

  const getCashouts = useCashoutStore(
    state => state.getReferralPendingCreditRequest
  );
...
export default AgentCashoutRequestTable;
