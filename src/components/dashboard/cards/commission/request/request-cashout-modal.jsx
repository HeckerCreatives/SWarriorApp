...
const RequestCashoutModal = data => {
  ...
  const request = useUserStore(state => state.requestCommsCashout);
  const reset = useUserStore(state => state.resetSuccess);
  const loading = useUserStore(state => state.loading.cashoutComms);
  ...
  const handleSubmit = e => {
    ...
    Swal.fire({
      title: `Are you sure you want to transfer ${amount.value} commission to your credits?`,
      showDenyButton: true,
